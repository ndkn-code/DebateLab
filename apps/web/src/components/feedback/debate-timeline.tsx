...
import { getRoundText } from "@/lib/feedback/debate-review";
...
export function DebateTimeline({ rounds }: DebateTimelineProps) {
  const t = useTranslations("sessionResult.timeline");
            ...
            >
              ...
              <AnimatePresence>
                {isExpanded && (
                  ...
                  >
                    <p className="mt-3 whitespace-pre-wrap border-t border-outline-variant/10 pt-3 font-sans text-sm leading-7 text-on-surface-variant">
                      {text}
                    </p>
                  </motion.div>
                )}
