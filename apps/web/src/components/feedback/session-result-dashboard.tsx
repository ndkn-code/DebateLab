  ...
  if (!viewModel) {
    return (
      <div className="mx-auto max-w-6xl px-4 py-8 sm:px-6 lg:px-8">
        <div className="rounded-control border border-outline-variant bg-surface p-6 text-center text-on-surface-variant shadow-none">
          {t("noFeedback")}
        </div>
      </div>
    );
  ...
  return (
    ...
    >
      <div className="mb-4 flex flex-wrap items-center justify-between gap-3">
        ...
        <div className="flex items-center gap-3">
          <Button
            ...
            variant="outline"
            onClick={handleShare}
            className="h-8 rounded-control border-outline-variant bg-surface px-5 text-on-surface-variant shadow-none hover:bg-surface-container"
          >
          ...
          <Button
            type="button"
            variant="outline"
            className="h-8 w-12 rounded-control border-outline-variant bg-surface p-0 text-on-surface-variant shadow-none hover:bg-surface-container"
        ...
        <div className="grid gap-7 lg:grid-cols-[300px_minmax(0,1fr)] xl:grid-cols-[330px_minmax(0,1fr)]">
          ...
          <div className="relative min-w-0 py-2 pr-0 sm:pr-6">
            <Button
              type="button"
              variant="ghost"
              className="absolute right-0 top-0 hidden h-10 w-10 rounded-control p-0 text-on-surface-variant hover:bg-surface-container sm:flex"
              ...
              <div className="min-w-0">
                ...
                {winnerResult && (
                  <div className="mt-4 flex flex-wrap items-center gap-2">
                    <span className="inline-flex items-center gap-2 rounded-control bg-primary-container px-3 py-2 text-sm font-bold text-primary ring-1 ring-outline-variant">
                    ...
                    <span className="rounded-control bg-background px-3 py-2 text-xs font-semibold text-on-surface-variant ring-1 ring-outline-variant">
                      {t("winner.confidence", {
      ...
      <div className="mt-5 grid gap-4 xl:grid-cols-3">
        <div className="rounded-control border border-outline-variant bg-surface p-5 shadow-none">
      ...
      {hasLearningReview && (
        <section className="mt-5 grid gap-4 xl:grid-cols-[minmax(0,0.92fr)_minmax(0,1.08fr)]">
          {viewModel.prepNotes && (
            <div className="rounded-control border border-outline-variant bg-surface p-5 shadow-none sm:p-6">
              <div className="flex flex-wrap items-start justify-between gap-3">
                ...
                <span className="rounded-control bg-surface-container px-3 py-2 text-xs font-bold text-on-surface-variant ring-1 ring-outline-variant">
              ...
              {viewModel.feedback.noteTakingFeedback && (
                <div className="mt-4 grid gap-3 lg:grid-cols-3">
                  <div className="rounded-control bg-success-container/40 p-4 ring-1 ring-outline-variant">
                  ...
                  <div className="rounded-control bg-warning-container/35 p-4 ring-1 ring-outline-variant">
                    <div className="flex items-center gap-2 text-sm font-bold text-on-surface">
                  ...
                  <div className="rounded-control bg-surface-container p-4 ring-1 ring-outline-variant">
                    <div className="flex items-center gap-2 text-sm font-bold text-on-surface">
          ...
          <div
            className={cn(
              "rounded-control border border-outline-variant bg-surface p-5 shadow-none sm:p-6",
                ...
                {viewModel.improvementPlan.map((step, index) => {
                  ...
                  return (
                    <article
                      ...
                      className="rounded-control border border-outline-variant bg-surface-container p-4"
                    >
      ...
      {scoreRationale && (
        <section className="mt-5 rounded-control border border-outline-variant bg-surface p-5 shadow-none sm:p-6">
          <div className="flex flex-wrap items-start justify-between gap-3">
            <div>
            ...
            <span className="rounded-control bg-primary-container px-3 py-2 text-sm font-bold text-primary ring-1 ring-outline-variant">
      ...
      {hasCasework && (
        <div className="mt-5 rounded-control border border-outline-variant bg-surface p-5 shadow-none sm:p-6">
          <div className="flex flex-wrap items-start justify-between gap-3">
            <div>
              <h2 className="text-base font-bold text-on-surface">
                {t("casework.heading")}
      ...
      <div className="mt-5 rounded-control border border-outline-variant bg-surface p-5 shadow-none sm:p-6">
        ...
        <div className="mt-4 grid gap-5 xl:grid-cols-[1fr_1fr_1.05fr] xl:divide-x xl:divide-outline-variant">
          ...
          <div className="rounded-control bg-surface-container p-5 xl:ml-6">
            <div className="flex items-center gap-2 text-sm font-bold text-primary">
        ...
        {showInlineReviewControls && (
          <div className="mt-5 flex flex-wrap items-center gap-3 border-t border-outline-variant pt-5">
            <Button
              ...
              className="min-h-[44px] rounded-control px-4 text-primary hover:bg-primary-container"
            >
        ...
        {showInlineReviewControls && showTranscript && (
          <div className="mt-4 rounded-control border border-outline-variant bg-surface-container p-5">
