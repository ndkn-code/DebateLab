  ...
  return (
    <div className="mx-auto max-w-4xl px-4 py-6 sm:px-6 space-y-6">
      ...
      <div className="rounded-[12px] bg-surface-container-lowest border border-outline-variant p-5 shadow-none">
        {previewMode ? (
          <div className="mb-4 rounded-control border border-primary/20 bg-primary-container/50 p-4">
        ...
        {previewMode ? (
          ...
          <button
            ...
            className="mt-4 inline-flex h-8 items-center rounded-control bg-primary px-4 text-sm font-medium text-on-primary transition-colors hover:bg-primary-dim focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary/40"
          >
            {t("enroll")}
          </button>
        )}
      ...
      <div className="space-y-4">
        {modules.map((mod, mi) => {
          ...
          return (
            <div key={mod.id as string} className="rounded-control bg-surface-container-lowest border border-outline-variant shadow-none overflow-hidden">
