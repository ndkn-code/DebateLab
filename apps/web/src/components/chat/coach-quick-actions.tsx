...
const QUICK_ACTION_ICONS = [MessageSquareText, Scale, Lightbulb, Sparkles] as const;
          ...
          <button
            ...
            className={cn(
              layout === "cards"
                ...
                : "rounded-full border border-outline-variant/20 bg-surface-container-lowest px-3 py-2 text-left text-sm font-medium text-on-surface-variant transition-colors hover:border-primary/30 hover:bg-primary/5 hover:text-on-surface disabled:pointer-events-none disabled:opacity-60",
