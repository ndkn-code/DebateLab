          ...
          <button
            ...
            className={cn(
              layout === "cards"
                ...
                : "rounded-[10px] border border-outline-variant bg-surface-container-lowest px-3 py-2 text-left type-label font-medium text-on-surface-variant transition-colors hover:border-primary/30 hover:bg-primary/5 hover:text-on-surface disabled:pointer-events-none disabled:opacity-60",
