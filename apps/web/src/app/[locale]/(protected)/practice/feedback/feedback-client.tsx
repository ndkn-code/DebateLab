      ...
      <div className="py-2">
        ...
        {error && (
          <div className="flex min-h-[60vh] flex-col items-center justify-center gap-4">
            <div className="rounded-control border border-error/20 bg-error-container px-4 py-3 text-center">
                  ...
                  afterPanel={
                    <>
                      {referralCode && feedback && (
                        <div className="mx-auto max-w-7xl rounded-control border border-success/30 bg-success-container p-4">
                          <div className="flex flex-col items-center text-center">
                            ...
                            <button
                              ...
                              className="mt-4 flex h-8 items-center gap-2 rounded-control bg-primary px-4 text-sm font-medium text-on-primary transition-colors hover:bg-primary-dim focus-visible:ring-2 focus-visible:ring-ring"
                            >
                              {linkCopied ? (
                                <>
