...
- `AI_GRADING_BACKEND=legacy` pauses new IELTS Writing/Speaking scoring with an
  actionable 503 before charging or persistence. It does not run a second
  legacy IELTS scorer. Existing runs and checkpoints are retained.
