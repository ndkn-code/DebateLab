...
const approvedPathFragments = [
  ...
  // Legacy un-migrated feedback/practice files (still raw-color). The analytics
  // surfaces in these folders moved to ChartKit in B1–B6 / WS-C1.
  "apps/web/src/components/feedback/annotated-transcript.tsx",
  "apps/web/src/components/feedback/category-cards.tsx",
  "apps/web/src/components/feedback/clash-map-board.tsx",
  "apps/web/src/components/feedback/score-hero.tsx",
  "apps/web/src/components/landing/",
  "apps/web/src/components/onboarding/",
  "apps/web/src/components/practice/category-visual.tsx",
  "apps/web/src/components/practice/countdown-timer.tsx",
  "apps/web/src/components/practice/mic-check.tsx",
  "apps/web/src/components/practice/practice-session-ui.tsx",
  "apps/web/src/components/practice/session-config.tsx",
  "apps/web/src/components/practice/speaking-phase.tsx",
  "apps/web/src/components/practice/topic-row.tsx",
